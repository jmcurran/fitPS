...
#' public.
#'
#' @format A \code{list} with five objects of class \code{psData}---see
#'   \code{\link{readData}} for more details. The elements of the list are
#'   named: \code{jackson}, \code{lau}, \code{pettard}, \code{ross}, and
#'   \code{roux}, corresponding to the lead author in each of the references
#'   given below. \code{lau}, \code{pettard}, and \code{ross} were taken from
