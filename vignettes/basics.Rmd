...
For a two-parameter zero-inflated zeta fit, `plotUncertainty()` provides the common parameter-uncertainty display used throughout fitPS. For an MLE fit it draws the established likelihood-ratio confidence region. The numerical contour coordinates remain available from `confint()` when they are needed for downstream calculations rather than plotting.
