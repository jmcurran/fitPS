...
The public transformation contract has three parts:
...
All three transformation methods must return or accept named vectors whose names and order match `modelParameterNames(model)`. Keeping that contract exact is important because the generic MCMC engine has no model-specific knowledge with which to repair ambiguous parameter ordering.
