 Psurveys = list(
  ...
  lewis.all = makeData(n = 0:1,
                       count = c(403, 7),
                       type = "P",
                       notes = bibentry(bibtype = "Article",
                                        author = c(as.person("A. D. Lewis"),
                                                   as.person("L. C. Alexander"),
                                                   as.person("O. Ovide"),
                                                   as.person("O. Duffett"),
                                                   as.person("J. M. Curran"),
                                                   as.person("P. Buzzini"),
                                                   as.person("T. Trejos")),
