---
title: "Comparing probability models for the Roux survey"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Comparing probability models for the Roux survey}
...
These distinctions matter for later uncertainty work. DIC uses the posterior distribution of model deviance; posterior predictive probabilities average model probabilities over parameter uncertainty; and a future Bayesian Bootstrap analysis would represent a different source or formulation of uncertainty. They should not be treated as synonyms.
